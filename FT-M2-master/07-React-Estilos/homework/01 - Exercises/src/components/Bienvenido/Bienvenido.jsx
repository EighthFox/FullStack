...
const h1Style = { // inlineStyling
  color: 'red',
};

export default function Bienvenido () {
  return (
    <div className={styles.divBienvenido}>  {/* CSS Module */}
      <h1 style={h1Style} className={styles.title}>soy Henry!</h1>  {/* InlineStyling and CSS Module */}

...
const addCars = (car, brand) => {
  if (utils.cars.find(c => c.id === car.id)) throw Error("Este coche ya existe en la base de datos");
  if (utils.brands.find(b=> b.name === brand.name)) throw Error("Esta marca ya existe en la base de datos");

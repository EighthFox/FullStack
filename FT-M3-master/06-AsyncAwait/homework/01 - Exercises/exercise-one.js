...
async function problemA() {
  ...
  // Tu código acá:
    ...
    // try{
    //   await exerciseUtils.promisifiedReadFile("poem-one/stanza-01.txt").then(
...
async function problemB() {
  ...
  // Tu código acá:
  try{
    await exerciseUtils.promisifiedReadFile("poem-one/stanza-02.txt").then(
    (stanza2) => exerciseUtils.blue(stanza2)
  );
    await exerciseUtils.promisifiedReadFile("poem-one/stanza-03.txt").then(
...
async function problemD() {
  ...
  // Tu código acá:
  try{
    await exerciseUtils.promisifiedReadFile("poem-one/wrong-file-name.txt").then(
